/**
  ...
  pero no puede haber más de un reno por establo. Además, 
  ...
  Nota: Ten en cuenta que el array de establos siempre tendrá el mismo 
  tamaño que el array de renos y que siempre los establos serán únicos.
